 ...
 * It captures mono S16LE PCM and sends the bytes verbatim; the server resamples
 * to 8 kHz and encodes G.711 for the camera. This socket is send-only — the
 * camera's own audio is heard through the normal live stream.
 *
...
public class TalkClient {
    ...
    public TalkClient(String talkUrl, String authorizationHeader, Listener listener) {
    ...
    public void start() {
        ...
        ws = client.newWebSocket(request, new WebSocketListener() {
            ...
            public void onOpen(WebSocket webSocket, Response response) {
                // Handshake with the capture rate; capture itself waits for the PTT button.
